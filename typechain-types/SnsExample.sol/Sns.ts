...
export interface SnsInterface extends utils.Interface {
  functions: {
...
export interface Sns extends BaseContract {
  ...
  functions: {
    getAllPosts(overrides?: CallOverrides): Promise<[Sns.PostStructOutput[]]>;
