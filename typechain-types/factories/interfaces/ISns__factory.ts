...
/* eslint-disable */
import type { ISocialNetwork, ISocialNetworkInterface } from "../../interfaces/ISocialNetwork";
...
export class ISocialNetwork__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): ISocialNetwork {
